...
export default class Weather extends Component {
    ...
    constructor() {
        super();
        AsyncStorage.getItem('weatherCity').then((data)=>{ weatherCity= data});
        AsyncStorage.getItem('now_weather').then((data)=>{ now_weather= data});
        AsyncStorage.getItem('now_temperature').then((data)=>{ now_temperature= data});
        AsyncStorage.getItem('f1').then((data)=>{ f1= JSON.parse(data)});
        AsyncStorage.getItem('f2').then((data)=>{ f2= JSON.parse(data)});
        AsyncStorage.getItem('f3').then((data)=>{ f3= JSON.parse(data)});
        AsyncStorage.getItem('f4').then((data)=>{ f4= JSON.parse(data)});
        AsyncStorage.getItem('f5').then((data)=>{ f5= JSON.parse(data)});
        AsyncStorage.getItem('f6').then((data)=>{ f6= JSON.parse(data)});
        AsyncStorage.getItem('f7').then((data)=>{ f7= JSON.parse(data)});
        AsyncStorage.getItem('tigan_temperature').then((data)=>{ tigan_temperature= data});
        AsyncStorage.getItem('sd').then((data)=>{ sd= data});
        AsyncStorage.getItem('jiangshui').then((data)=>{ jiangshui= data});
        AsyncStorage.getItem('fx').then((data)=>{ fx= data});
        AsyncStorage.getItem('fl').then((data)=>{ fl= data});
        AsyncStorage.getItem('zwx').then((data)=>{ zwx= data});
        AsyncStorage.getItem('qy').then((data)=>{ qy= data});
        AsyncStorage.getItem('quality').then((data)=>{ quality= data});
        AsyncStorage.getItem('hours_list').then((data)=>{ console.log("data",JSON.parse(data));hours_list= JSON.parse(data)});
        this.state = {
            localCity: '',
            ...
            return (
                <View key={hourIndex} style={styles.hours_list_item}>
                    ...
                    <Image
                        ...
                        source={{uri: convertCodeToImage(hourElem.weather_code)}}
                    />
            ...
            <View style={styles.container}>
                <ScrollView ref={(scrollView) => {
                    ...
                    <View style={styles.f}>
                        ...
                        <Text style={styles.f_text}>{this.state.f1.night_air_temperature+'°-'+this.state.f1.day_air_temperature+'°'}</Text>
                    </View>
                    ...
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f2.night_air_temperature+'°-'+this.state.f2.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f3.night_air_temperature+'°-'+this.state.f3.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f4.night_air_temperature+'°-'+this.state.f4.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f5.night_air_temperature+'°-'+this.state.f5.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f6.night_air_temperature+'°-'+this.state.f6.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.f}>
                        ...
                        />
                        <Text style={styles.f_text}>{this.state.f7.night_air_temperature+'°-'+this.state.f7.day_air_temperature+'°'}</Text>
                    </View>
                    <View style={styles.line}></View>
